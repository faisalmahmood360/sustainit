...
import 'package:foodapp/screens/stepper/step_three.dart';
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      ...
      children: [
        ...
        Expanded(
          child: Center(
            child: SvgPicture.asset('assets/images/stepper/step2.svg'),
          ),
        ),
        Container(
                ...
                children: [
                  SizedBox(
                    ...
                    child: RaisedButton(
                      ...
                      child: SvgPicture.asset('assets/images/stepper/back.svg'),
                    ),
                  ),
                  SizedBox(
                    height: 50,
                    ...
                    child: RaisedButton(
                      ...
                      shape: RoundedRectangleBorder(
                          borderRadius: new BorderRadius.circular(10.0)),
                      child: SvgPicture.asset('assets/images/stepper/next.svg'),
                    ),
                  ),
                ],
              )
