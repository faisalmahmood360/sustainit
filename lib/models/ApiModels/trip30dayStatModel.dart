...
TripLastMonthStat tripLastMonthStatFromJson(String str) => TripLastMonthStat.fromJson(json.decode(str));

String tripLastMonthStatToJson(TripLastMonthStat data) => json.encode(data.toJson());

class TripLastMonthStat {
  TripLastMonthStat({
    this.success,
    this.data,
    this.message,
  ...
  factory TripLastMonthStat.fromJson(Map<String, dynamic> json) => TripLastMonthStat(
